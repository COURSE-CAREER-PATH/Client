...
import { X, MenuIcon, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="">
      <nav className="fixed w-full -top-1 z-50 backdrop-blur-xl border-b border-neutral-80 flex items-center justify-between lg:gap-8 px-5">
        ...
        <div className="hidden lg:flex  items-center gap-3 lg">
        <Link to={'/login'} className=''>
            <Buttons value={'Get Started'} icon={(<ArrowRight/>)}/>
            </Link>
     </div>
      ...
      {mobileDrawerOpen && (
        <div className=" fixed  flex flex-col backdrop-blur-lg border-b border-neutral-700/80 w-full items-center justify-center py-10 lg:hidden md:flex top-10 z-20 h-auto
        ">
          <ul>
          <Link to={'/dept'}>
